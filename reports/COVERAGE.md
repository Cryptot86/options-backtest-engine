...
| 10x100 crosses (all fut) |    31 |       480 |      340 |       70.8 |
| MSFT puts (same-day)     |     3 |       225 |      206 |       91.6 |
...
- **ES puts (D+1)** (run 29): {'price_missing_or_error': 202, 'no_expiry_in_window': 20, 'no_definitions': 42}
- **GC puts (D+1)** (run 30): {'price_missing_or_error': 114, 'no_definitions': 6}
- **NG calls (same-day)** (run 21): {'price_missing_or_error': 71, 'no_definitions': 5}
...
- **10x100 crosses (all fut)** (run 31): {'price_missing_or_error': 81, 'no_definitions': 52, 'no_expiry_in_window': 7}
- **MSFT puts (same-day)** (run 3): {'equity_unpriced': 19}
- **AAPL puts (same-day)** (run 32): {'equity_unpriced': 11}

**TOTAL: 7108/8884 = 80.0% coverage**
