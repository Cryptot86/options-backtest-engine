...
| **Trend-flip exit counterfactual (2026-07-27, $0 cache)** | ADDING "exit when 10x100 flips" to CL calls destroys 64% of 13yr profit ($28,872→$10,292, n=342): the cross fires AFTER the damage, crystallizing max pain (affected trades −$140→−$375 avg). On bb_2sd_call specifically it's a statistical wash (n=29, Δ$270). LAW UNCHANGED: 50%/21DTE only; trend governs ENTRIES, never exits. | this scoreboard entry |
