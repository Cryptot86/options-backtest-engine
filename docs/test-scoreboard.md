...
| **Stock exit-type shootout (2026-08-01, TJ's 10x100 system, \$0)** | 5 majors, 10yr, \$10K/pos, exits isolated: cross-only \$178.9K tot/DD 11.75 · **fixed 2xATR initial stop \$179.5K / DD −14% / ratio 13.67 — CANDIDATE for OOS in the stock engine** (never touches winners: NVDA +656% intact; only trims immediate failures, worst −\$1,525 vs −\$2,214) · **chandelier 3xATR trail = WEALTH DESTROYER: −36% of book (\$115K), chokes NVDA at +158% vs +656%** · −15% breaker inert. ARM verdict quantified: median winner giveback = 54% (ARM's 66% is normal); the exit that spares the giveback costs 36% of everything. Cross-only stays law; 2xATR verdict goes to TJ's engine for TSP-sized OOS. | run_stock_exit_shootout.py |
